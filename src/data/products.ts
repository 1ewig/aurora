...
export const heroProducts: Product[] = [
  {
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["wool","overcoat","coat","winter","warm","outerwear","double-breasted","italian","ivory","cream"]
  },
  {
    id: "h2",
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["cashmere","turtleneck","sweater","warm","knitwear","camel","mongolian","scotland"]
  },
  {
    id: "h3",
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["linen","blazer","summer","lightweight","outerwear","ecru","mannequin","portugal"]
  },
  {
    id: "h4",
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["wool","trousers","pants","wide-leg","charcoal","tailored","japan"]
  },
  {
    id: "h5",
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["silk","slip","dress","gold","champagne","heavyweight","mulberry","france"]
  }
];
...
export const allProducts: Product[] = [
  {
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["camel","coat","wrap","outerwear","hair","winter","warm","italy"]
  },
  {
    id: "p7",
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["wool","overcoat","coat","winter","warm","outerwear","ebony","black","london"]
  },
  {
    id: "p8",
    ...
    sizes: ["One Size"],
    keywords: ["silk","scarf","amber","gold","twill","hand-rolled","france","accessories"]
  },
  {
    id: "p9",
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["merino","wool","crewneck","sweater","charcoal","knitwear","japan"]
  },
  {
    id: "p10",
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["wool","silk","trousers","pants","black","tailored","crease","italy"]
  },
  {
    id: "p11",
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["velvet","silk","dress","midi","emerald","green","evening","france"]
  },
  {
    id: "p12",
    ...
    keywords: ["leather","belt","oak","brown","brass","buckle","accessories","england"]
  },
  {
    id: "p13",
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["wool","peacoat","coat","winter","warm","outerwear","navy","blue","japan"]
  },
  {
    id: "p14",
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["cashmere","cardigan","sweater","warm","knitwear","ivory","white","scotland"]
  },
  {
    id: "p15",
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["crepe","jumpsuit","mock-neck","sleeveless","ivory","white","dresses","italy"]
  },
  {
    id: "p16",
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["camel","hair","cardigan","sweater","warm","knitwear","scotland"]
  },
  {
    id: "p17",
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["wool","cashmere","overcoat","coat","winter","warm","outerwear","charcoal","grey","italy"]
  },
  {
    id: "p18",
    ...
    sizes: ["XS","S","M","L","XL"],
    keywords: ["wool","crepe","satin","silk","blazer","jacket","black","tailored","italy"]
  }
];
