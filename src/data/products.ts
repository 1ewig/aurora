...
export const heroProducts: Product[] = [
  {
    ...
    images: ["/images/hero-product-1.webp", "/images/lookbook-1.webp", "/images/lookbook-3.webp"],
    ...
    details: [
      "100% fine Italian virgin wool",
      "Tailored fit with structured shoulders",
      "Fully lined in 100% cupro silk",
      "Double-breasted button closure with horn buttons",
  ...
  },
  {
    ...
    images: ["/images/hero-product-2.webp", "/images/lookbook-2.webp", "/images/lookbook-5.webp"],
    ...
    details: [
      ...
      "12-gauge knit for a dense, soft feel",
  ...
  },
  {
    ...
    images: ["/images/hero-product-3.webp", "/images/lookbook-3.webp", "/images/lookbook-6.webp"],
    ...
    details: [
      ...
      "Unstructured, breathable build",
      "Two-button closure with mother-of-pearl buttons",
      "Dual vent back for comfort and mobility",
  ...
  },
  {
    ...
    images: ["/images/hero-product-4.webp", "/images/lookbook-4.webp", "/images/lookbook-2.webp"],
    ...
    details: [
      "100% wool crepe",
      "High-rise fit with front pleats",
      "Concealed zip fly with hook-and-eye closure",
      "Side slip pockets and back welt pockets",
      "Dry clean only",
      "Crafted in Japan"
    ],
    sizes: sizeOptions.apparel,
  },
  {
    ...
    images: ["/images/hero-product-5.webp", "/images/lookbook-5.webp", "/images/lookbook-1.webp"],
...
export const allProducts: Product[] = [
  {
    ...
    images: ["/images/camel-wrap-coat.webp", "/images/lookbook-2.webp"],
    ...
    details: [
      "100% luxury camel hair",
      "Hand-stitched edge detailing",
      "Belted wrap design with relaxed shoulder silhouette",
      "Large functional patch pockets",
      "Dry clean only",
      "Made in Italy"
    ],
    sizes: sizeOptions.apparel,
  },
  {
    ...
    images: ["/images/ebony-wool-overcoat.webp", "/images/lookbook-4.webp"],
    ...
    details: [
      "100% heavyweight felted wool",
      "Structured peak lapels",
  ...
  },
  {
    ...
    images: ["/images/silk-scarf-amber.webp", "/images/lookbook-6.webp"],
    ...
    details: [
      "100% silk twill",
      "Hand-rolled edges",
      "Exquisite abstract print design",
      "90cm x 90cm square size",
  ...
  },
  {
    ...
    images: ["/images/charcoal-merino-crewneck.webp", "/images/lookbook-2.webp"],
    ...
    details: [
      ...
      "Extrafine 18-gauge knit structure",
  ...
  },
  {
    ...
    images: ["/images/black-tailored-trousers.webp", "/images/lookbook-1.webp"],
    ...
    details: [
      "85% wool, 15% silk blend",
      "Mid-rise with structured waist bands",
      "Pressed crease along front and back",
      "Concealed button and zip closure",
      "Dry clean only",
      "Crafted in Italy"
    ],
    sizes: sizeOptions.apparel,
  },
  {
    ...
    images: ["/images/emerald-velvet-midi-dress.webp", "/images/lookbook-5.webp"],
    ...
    details: [
      "80% viscose, 20% silk velvet",
      "Mock neck with back ribbon closure",
      "Discreet side zipper",
      "Slightly structured puff sleeve detail",
      "Dry clean only",
      "Made in France"
    ],
    sizes: sizeOptions.apparel,
  },
  {
    ...
    images: ["/images/leather-belt-oak.webp", "/images/lookbook-4.webp"],
    ...
    details: [
      ...
      "Solid brass buckle detail",
      "3cm width, versatile for loop fits",
      "Hand-painted and burnished edges",
      "Wipe clean with dry cloth, leather conditioner safe",
      "Crafted in England"
    ],
  ...
  },
  {
    ...
    images: ["/images/navy-wool-peacoat.webp", "/images/lookbook-3.webp"],
    ...
    details: [
      "100% heavy Melton wool",
      "Double-breasted front with anchor-engraved buttons",
      "Warm moleskin pocket lining",
      "Tailored fit with structural cuffs",
      "Dry clean only",
      "Made in Japan"
    ],
    sizes: sizeOptions.apparel,
  },
  {
    ...
    images: ["/images/ivory-cashmere-cardigan.webp", "/images/lookbook-1.webp"],
    ...
    details: [
      "100% pure organic cashmere",
      "Heavy rib knit with V-neck construction",
      "Large mock-horn button front closure",
