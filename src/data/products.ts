...
export const allProducts: Product[] = [
  ...
  },
  {
    ...
    details: [
      "100% fine camel hair",
      "Mock-horn front buttons",
      "Rib-knit cuffs, hem, and pocket openings",
  ...
  },
  {
    ...
    details: [
      ...
      "Double-breasted front with matching buttons",
      "Fully lined in premium cupro",
      "Professional dry clean only",
  ...
  },
  {
    ...
    details: [
      "100% wool crepe with satin silk details",
      "Single-button front closure",
