    ...
    <>
      {user && (
        <div className="fixed inset-0 z-50 overflow-y-auto p-4 sm:p-6 md:p-10 flex items-center justify-center">
          ...
          {/* Dialog Content */}
          <div
            className="relative w-full max-w-2xl bg-bg-secondary border border-border-subtle rounded-[24px] shadow-2xl flex flex-col max-h-[85vh]"
          >
            {/* Header */}
            ...
            {/* Footer Actions */}
            <div className="flex-shrink-0 flex items-center justify-between px-6 sm:px-6 py-4 sm:py-4 border-t border-border-subtle bg-bg-primary/30">
              {isAdmin && (
                <Button
                  type="button"
