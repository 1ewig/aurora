  ...
  return (
    <div className="space-y-8 pb-12 animate-pulse">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="h-12 w-36 bg-bg-secondary rounded-full" />
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="border-b border-border-subtle bg-bg-primary/50">
              {["Time", "Action", "Target", "Admin", "Target ID"].map((h) => (
            ...
            {Array.from({ length: 5 }).map((_, i) => (
              <tr key={i}>
                <td className="px-6 py-4">
                  <div className="h-4 w-32 bg-bg-primary rounded font-mono" />
                </td>
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4">
                  <div className="h-4 w-40 bg-bg-primary rounded" />
                </td>
                <td className="px-6 py-4">
